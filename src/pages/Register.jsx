...
export default function Register() {
  const { registerStudent, loading } = useContext(AuthContext);
  ...
  return (
    <main className="flex min-h-screen items-center justify-center bg-[radial-gradient(circle_at_top,#087765,#07362e_52%,#052821)] px-4 py-8">
      <section className="w-full max-w-md rounded-[28px] bg-white p-6 shadow-2xl sm:p-8">
        ...
        <div className="mb-7">
          <h1 className="text-2xl font-extrabold text-gray-900">Criar conta de aluno</h1>
          <p className="mt-2 text-sm leading-6 text-gray-500">
            Use seus dados para reservar e acompanhar retiradas.
          </p>
        </div>
